...
namespace System.Buffers
{
    ...
    /// </summary>
    [SuppressMessage("Usage", "CA1816", Justification = "System.Buffers class")]
    internal sealed class SlabMemoryPool : MemoryPool<byte>
    {
        ...
        {
            if (_isDisposed) MemoryPoolThrowHelper
                .ThrowObjectDisposedException(MemoryPoolThrowHelper.ExceptionArgument.MemoryPool);
        ...
        internal void Return(MemoryPoolBlock block)
        {
            ...
            if (!_isDisposed) _blocks.Enqueue(block);
            else GC.SuppressFinalize(block);
        }
