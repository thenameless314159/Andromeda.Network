...
#pragma warning disable CS8768 // La nullabilité des types référence dans le type de retour ne correspond pas au membre implémenté (probablement en raison des attributs de nullabilité).
        TFeature? IFeatureCollection.Get<TFeature>() where TFeature : default
#pragma warning restore CS8768 // La nullabilité des types référence dans le type de retour ne correspond pas au membre implémenté (probablement en raison des attributs de nullabilité).
        {
